...
module "eks" {
  ...
  node_security_group_additional_rules = {
    ...
    ingress_cluster_api_to_istiod_webhook = {
    ...
    ingress_self_all_to_all = {
      # This is important for the istio-proxy healthcheck to work (port 15021).
      # I tried to add port 15021 only but it failed (investigate).
